"""
FakeChatModel implementation for deterministic testing.

This module provides a fake chat model that can be used in tests to simulate
LLM responses without making actual API calls. It supports predefined response
patterns for testing agent reasoning.
"""
